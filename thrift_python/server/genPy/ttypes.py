...
class Request(object):
    ...
    def __init__(self, paramJSON=None, serviceName=None,):
...
class ServiceException(TException):
    ...
    def __init__(self, exceptionCode=None, exceptionMess=None,):
        super(ServiceException, self).__setattr__('exceptionCode', exceptionCode)
        super(ServiceException, self).__setattr__('exceptionMess', exceptionMess)
    ...
    def __hash__(self):
        return hash(self.__class__) ^ hash((self.exceptionCode, self.exceptionMess, ))
    ...
    def read(cls, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRING:
                    exceptionMess = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
